...
" Author: itchyny & blingoose
" License: MIT License
" Last Change: 2024/06/30 00:57:05.
" =============================================================================
...
let s:skyblue = [ '#87afff', s:cuicolors.skyblue[s:cuiindex] ]
...
let s:p.normal.hint = [ [ s:base03, s:skyblue ] ] 
let s:p.normal.info = [ [ s:base03, s:base1 ] ]
